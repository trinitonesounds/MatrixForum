...
Notes from Curtis:
- I was looking into storing the photos in the db, but it's pretty cumbersome because you have to 
...
- I added a CHANGELOG file to document things as we've changed/added.
